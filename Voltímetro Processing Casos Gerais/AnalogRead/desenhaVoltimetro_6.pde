void desenhaVoltimetro_6() {
  float valor_convertido = valVolts * (1000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(22);
  text("0  100   250    400     550   700           1KV", 255, 245);
  textSize(30);
  text("Tensão = " + nf(valor_convertido, 0, 3) + " V", 300, 320);
  ...
  desenharVoltimetro6(260, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro6(float x, float y, float comprimento, float altura) {
