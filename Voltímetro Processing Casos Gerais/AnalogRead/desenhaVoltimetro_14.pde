void desenhaVoltimetro_14() {
  float valor_convertido = valVolts * (150000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(19);
  text("0  10k   27k    46k    65k    85k   103k  122k 150k", 245, 245);
  textSize(30);
  ...
  desenharVoltimetro14(250, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro14(float x, float y, float comprimento, float altura) {
