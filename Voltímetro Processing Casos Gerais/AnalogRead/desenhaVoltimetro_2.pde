void desenhaVoltimetro_2() {
  float valor_convertido = valVolts * (65.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 320, 210);
  textSize(22);
  text("0      10     20     30    40    50        65", 302, 245);
  textSize(30);
  text("Tensão = " + nf(valor_convertido, 0, 3) + " V", 340, 320);
  ...
  desenharVoltimetro2(310, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro2(float x, float y, float comprimento, float altura) {
