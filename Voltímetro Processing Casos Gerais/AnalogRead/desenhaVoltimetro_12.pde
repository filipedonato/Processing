void desenhaVoltimetro_12() {
  float valor_convertido = valVolts * (64000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(20);
  text("0    5k    12k    21k    30k    38k    47k  54k   64k", 245, 245);
  textSize(30);
  ...
  desenharVoltimetro12(250, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro12(float x, float y, float comprimento, float altura) {
