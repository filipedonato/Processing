void desenhaVoltimetro_7() {
  float valor_convertido = valVolts * (2000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(22);
  text("0  200   500    750    1.1k   1.5k  1.7k  2k", 255, 245);
  textSize(30);
  ...
  desenharVoltimetro7(260, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro7(float x, float y, float comprimento, float altura) {
