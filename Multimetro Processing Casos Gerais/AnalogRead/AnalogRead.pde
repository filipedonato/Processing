...
if (valVoltsOriginal >= 0.1 && valVoltsOriginal < 0.2) {
  ...
  valVolts = valVoltsOriginal*1.03;
...
//--------------------------------------------------------------------------
  ...
  switch (selecionado) {
    ...
    case 9:
      ...
      break;
    case 10:
      desenhaVoltimetro_10();
      break;
    case 11:
      desenhaVoltimetro_11();
      break;
    case 12:
      desenhaVoltimetro_12();
      break;
    case 13:
      desenhaVoltimetro_13();
      break;
    case 14:
      desenhaVoltimetro_14();
      break;
    default:
