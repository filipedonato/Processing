void desenhaVoltimetro_4() {
  float valor_convertido = valVolts * (250.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 320, 210);
  textSize(22);
  text("0         50       100  140  180 210 250", 302, 245);
  textSize(30);
  ...
  desenharVoltimetro4(310, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro4(float x, float y, float comprimento, float altura) {
