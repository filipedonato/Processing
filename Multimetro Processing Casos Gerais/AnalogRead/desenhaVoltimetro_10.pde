void desenhaVoltimetro_10() {
  float valor_convertido = valVolts * (16000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(22);
  text("0    2k     4k      6k     8k   10k     13k    16k", 255, 245);
  textSize(30);
  ...
  desenharVoltimetro10(260, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro10(float x, float y, float comprimento, float altura) {
