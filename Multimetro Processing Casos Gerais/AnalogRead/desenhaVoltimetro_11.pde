void desenhaVoltimetro_11() {
  float valor_convertido = valVolts * (32000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(22);
  text("0    3k     8k     12k    17k    22k   26k  32k", 255, 245);
  textSize(30);
  ...
  desenharVoltimetro11(260, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro11(float x, float y, float comprimento, float altura) {
