void desenhaVoltimetro_8() {
  float valor_convertido = valVolts * (4000.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 300, 210);
  textSize(22);
  text("0  400   900   1.5k    2.2k   2.8k  3.3k  4k", 255, 245);
  textSize(30);
  ...
  desenharVoltimetro8(260, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro8(float x, float y, float comprimento, float altura) {
