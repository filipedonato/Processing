void desenhaVoltimetro_5() {
  float valor_convertido = valVolts * (500.0/3.3);
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 320, 210);
  textSize(22);
  text("0        100    200     300     400   500", 302, 245);
  textSize(30);
  ...
  desenharVoltimetro5(310, 250, comprimentoVoltimetro, 30);
  ...
  void desenharVoltimetro5(float x, float y, float comprimento, float altura) {
