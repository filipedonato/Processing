void desenhaVoltimetro_3() {
  float valor_convertido = (valVolts * (450000.00/3.15))/1000;
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 180, 210);
  textSize(22);
  text("0      45k      85k     140k    200k     265k     325k     380k     450k", 50, 245);
  textSize(30);
  ...
  desenharVoltimetro3(60, 250, comprimentoVoltimetro, 30);
