void desenhaVoltimetro_2() {
  float valor_convertido = (valVolts * (300000.00/3.15))/1000;
  fill(0);
  textSize(30);
  text("VOLTÍMETRO DIGITAL", 180, 210);
  textSize(22);
  text("0      28k      60k     93k      134k     175k     220k    250k     300k", 50, 245);
  textSize(30);
  ...
  desenharVoltimetro2(60, 250, comprimentoVoltimetro, 30);
